...
// Get all VIP room photos from room_images table
...
$vipPhotos = getRoomPhotos('VIP', 50);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>VIP Suites Gallery - Paradise Hotel & Resort</title>
    <meta name="description" content="Browse our exclusive VIP Suites gallery and book your ultimate luxury experience at Paradise Hotel & Resort.">
    ...
    <section class="gallery-header">
        <div class="container">
            <div class="gallery-header-content">
                <h1><i class="fas fa-gem"></i> VIP Suites Gallery</h1>
                <p>Experience the ultimate in luxury with our exclusive VIP Suites</p>
    ...
    <section class="gallery-section">
        <div class="container">
            <div class="gallery-grid">
                <?php if (!empty($vipPhotos)): ?>
                    <?php foreach ($vipPhotos as $index => $photo): ?>
                    <div class="gallery-item" data-index="<?php echo $index; ?>" data-image="<?php echo htmlspecialchars($photo['file_path']); ?>">
                        <img src="<?php echo htmlspecialchars($photo['file_path']); ?>" alt="VIP Suite <?php echo $index + 1; ?>" loading="lazy">
                ...
                <?php else: ?>
                    <div class="no-photos">
                        ...
                        <p>VIP suite photos will be displayed here once uploaded in the admin panel.</p>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="gallery-booking">
                <div class="booking-card">
                    ...
                    <p>Indulge in the ultimate luxury experience with our exclusive VIP Suites</p>
    ...
    <div id="lightbox" class="lightbox">
        <div class="lightbox-content">
            ...
            <div class="lightbox-counter">
                <span id="lightbox-current">1</span> / <span id="lightbox-total"><?php echo count($vipPhotos); ?></span>
            </div>
        </div>
    </div>
