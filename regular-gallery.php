...
// Get all regular room photos from room_images table
...
$regularPhotos = getRoomPhotos('Regular', 50);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Regular Rooms Gallery - Paradise Hotel & Resort</title>
    <meta name="description" content="Browse our Regular Rooms gallery and book your perfect stay at Paradise Hotel & Resort.">
    ...
    <section class="gallery-header">
        <div class="container">
            <div class="gallery-header-content">
                <h1><i class="fas fa-bed"></i> Regular Rooms Gallery</h1>
                <p>Discover our comfortable Regular Rooms designed for your perfect stay</p>
    ...
    <section class="gallery-section">
        <div class="container">
            <div class="gallery-grid">
                <?php if (!empty($regularPhotos)): ?>
                    <?php foreach ($regularPhotos as $index => $photo): ?>
                    <div class="gallery-item" data-index="<?php echo $index; ?>" data-image="<?php echo htmlspecialchars($photo['file_path']); ?>">
                        <img src="<?php echo htmlspecialchars($photo['file_path']); ?>" alt="Regular Room <?php echo $index + 1; ?>" loading="lazy">
                ...
                <?php else: ?>
                    <div class="no-photos">
                        ...
                        <p>Regular room photos will be displayed here once uploaded in the admin panel.</p>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="gallery-booking">
                <div class="booking-card">
                    ...
                    <p>Experience comfort and luxury in our Regular Rooms</p>
    ...
    <div id="lightbox" class="lightbox">
        <div class="lightbox-content">
            ...
            <div class="lightbox-counter">
                <span id="lightbox-current">1</span> / <span id="lightbox-total"><?php echo count($regularPhotos); ?></span>
            </div>
        </div>
    </div>
